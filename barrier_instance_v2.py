...
def main():
    ...
    for x in pairs:
        ...
        destination_blob_name = f'Neurips21/{save_dir}/barrier/SA_InstanceOptimized_v2/original/{source_file_name}'
    ...
    #     destination_blob_name = f'Neurips21/{save_dir}/barrier/SA_InstanceOptimized_v2/oracle/before/{source_file_name}'
    ...
    #     # destination_blob_name = f'Neurips21/{save_dir}/barrier/SA/auto/{source_file_name}'
    #     destination_blob_name = f'Neurips21/{save_dir}/barrier/SA_InstanceOptimized_v2/oracle/SA/grid/{exp_no}/{source_file_name}'
    #     pickle_out = pickle.dumps(dict_after)
    #     upload_pkl(bucket_name, pickle_out, destination_blob_name)
    # print()
    ...
    #     source_file_name = f'dict_after_{pair}.pkl'
    #     # destination_blob_name = f'Neurips21/{save_dir}/barrier/SA/auto/{source_file_name}'
    #     destination_blob_name = f'Neurips21/{save_dir}/barrier/SA_InstanceOptimized_v2/grid/{exp_no}/{source_file_name}'
    #     pickle_out = pickle.dumps(dict_after)
    #     upload_pkl(bucket_name, pickle_out, destination_blob_name)
    # print()
    # print("basin_mean_after", statistics.mean(barrier_test_basin))
...
def barrier_SA(arch, model, sd2, w2, init_state, tmax, tmin, steps, train_inputs, train_targets, nchannels, nclasses, nunits):
    ...
    class BarrierCalculationProblem(Annealer):
        ...
        def energy(self):
            ...
            eval_train = evaluate_model_small(permuted_avg, train_inputs, train_targets)['top1']
